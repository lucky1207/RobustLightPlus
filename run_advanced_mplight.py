...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,           default='no_advanced_mplight_u_rand_3.5')
...
def main(in_args=None):
    ...
    for traffic_file in traffic_file_list:
        dic_traffic_env_conf_extra = {
            ...
            "NOISE_SCALE": 3.5,
            "NOISE_TYPE": 1, # 每一个level有不同类型的noise，譬如level为0噪声类型有guassion，qmin，uniform，action_diff
