...
def parse_args():
    ...
    parser.add_argument("--memo",       type=str,               default='MaxPressure')
...
def main(in_args=None):
    ...
    for traffic_file in traffic_file_list:
        dic_traffic_env_conf_extra = {
            ...
            "NUM_ROW": NUM_ROW,
            "NUM_COL": NUM_COL,
            'diffusion_path': f'./checkpoints/unet_max/{in_args.traffic_file}/diffusion_model_meta_final.pth',
            ...
            "sota_path": '../RobustLight/model/MaxPressure/' + traffic_file[:-5],
